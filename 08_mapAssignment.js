class bank {
    ...
    this.intrestrate=intrestrate;
     ...
     mapOfBank.set("988855447722123",axisBank);
     mapOfBank.set("77331011000031",sbiBank);
     mapOfBank.set("78890032569078",iciciBank);
      mapOfBank.set("3344000965422109",kotakBank);
     mapOfBank.set("556673289210974",hdfcBank);
     mapOfBank.set("421100987654322",panjabBank);
     
    const  keyOfMap=mapOfBank.keys();
    console.log(keyOfMap)
    for (const element of keyOfMap) {
     const   bank = mapOfBank.get(element)
    console.log(bank.bank_name,bank.accountno,bank.intrestrate)
    }
