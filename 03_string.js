...
console.log("total  character inedex in the string:",greet.length);
console.log(" character at index 5:", greet.charAt(5));
var lengthTotal=greet.length;
console.log(" character at lastindex:", greet.charAt(lengthTotal-1));
console.log("======== concat() ==========");
var firstName = "Mohit ";
var lastName = "Sharma";
